...
interface GlowCardProps {
  ...
  /** When true, ignores `size` and uses `width`/`height` or `className` instead. */
  customSize?: boolean;
}
...
// Global CSS (the `[data-glow]::before/::after` rules) lives once in
// globals.css rather than being injected per-instance via a <style> tag.
export function GlowCard({
  ...
  // CSS custom properties aren't part of React.CSSProperties' typed surface,
  // so this is built as a loose record and cast at the JSX boundary.
